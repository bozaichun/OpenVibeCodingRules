...
- **质量基线**：全语言代码规范 / 质量 / 可维护性（`rules/CodingSpec/QualityBaseline.md`）
...
1. **新手使用前，请仔细阅读本使用说明文档**（`README.md`）。
2. **将本仓库中的 `rules/` 文件夹与 `AGENTS.md` 复制到你的业务项目根目录**，保持相对路径不变。示例：
...
│   ├── CodeConduct.md
│   └── CodingSpec/
│       ├── JavaScript&TypeScript/   # 前端：CodingSpec · DESIGN · WebVariable · PreView
│       ├── Node.js/ · Python/ · Java/ · Go/ · PHP/
│       ├── C/ · C++/ · CSharp/ · Rust/
│       ├── SQL/ · R/ · Kotlin/ · Swift/ · Dart/
│       ├── Ruby/ · Scala/ · Shell/
│       └── …/CodingSpec.md
├── src/
└── ...
...
│   ├── CodeConduct.md
│   └── CodingSpec/
│       ├── QualityBaseline.md         # 全语言：规范 / 质量 / 可维护性
│       ├── JavaScript&TypeScript/     # CodingSpec · DESIGN · WebVariable · PreView
│       ├── Node.js/CodingSpec.md
│       ├── Python/CodingSpec.md
│       ├── Java/CodingSpec.md
│       ├── Go/CodingSpec.md
│       ├── PHP/CodingSpec.md
│       ├── C/CodingSpec.md
│       ├── C++/CodingSpec.md
│       ├── CSharp/CodingSpec.md       # C#
│       ├── Rust/CodingSpec.md
│       ├── SQL/CodingSpec.md
│       ├── R/CodingSpec.md
│       ├── Kotlin/CodingSpec.md
│       ├── Swift/CodingSpec.md
│       ├── Dart/CodingSpec.md
│       ├── Ruby/CodingSpec.md
│       ├── Scala/CodingSpec.md
...
1. 确保根目录存在 `AGENTS.md`
2. `rules/CodeConduct.md` 已 `alwaysApply: true`
...
| `rules/CodingSpec/QualityBaseline.md` | 风格门禁、分层、接口、质量、技术债、可维护性 |
| `rules/CodingSpec/<语言>/CodingSpec.md` | 写对应语言业务代码 |
