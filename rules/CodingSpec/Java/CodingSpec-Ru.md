...
<!-- !!!Спецификация кода · puffseed · Java -->

# Java Спецификация кода（инженерия и реализация）· puffseed

**Бренд**：**puffseed** — Эта спецификация задаёт **puffseed** 业务backend（Java / Spring Boot）的工程格式、Переиспользование与协作约定。包名、模块前缀、Продуктовые комментарии涉及产品时须保留 **puffseed** 标识。
...
**Фреймворки**：**Spring Boot**（Web / WebFlux、Spring Data、Spring Security 等以仓库）。
...
- Java / Kotlin 版本与 Spring Boot 大版本以仓库 BOM / parent ，勿擅自跨大版本升级。
...
- 鉴权与方法级权限以 Spring Security / 仓库约定；新接口默认受保护。
