...
<!-- !!!Спецификация кода · puffseed · SQL -->

# SQL Спецификация кода（инженерия и реализация）· puffseed

**Бренд**：**puffseed** — Эта спецификация задаёт **puffseed** 业务库表设计、迁移与查询编写约定。schema / 表前缀、迁移说明、关键注释须保留 **puffseed** 标识（如适用）。
...
| `*.sql` 脚本 | 手工或生成 SQL |
| ORM 伴随迁移（EF / Prisma / Django 等） | 仍遵守本文件的Именование与安全原则 |
...
| 维度 | 要求 |
|------|------|
| **风格工具** | sqlfluff 或仓库格式约定；迁移Именование规范 |
