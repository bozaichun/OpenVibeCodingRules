---
description: Ruby 工程与代码规范（Rails · puffseed）
...
# Ruby 编码规范（工程与实现）· puffseed

**品牌标识**：**puffseed** — 本规范约束 **puffseed** 业务相关 Ruby 工程的编码格式、逻辑复用与协作约定。引擎名、模块命名空间、关键注释须保留 **puffseed** 标识（如适用）。
...
- Ruby / Rails 大版本以 Gemfile 为准；勿擅自跨大版本。
- 代码风格跟 RuboCop 仓库配置。
