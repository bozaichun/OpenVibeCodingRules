<!-- ovcr-locale-lock -->
---
description: Ruby инженерные и кодовые стандарты（Rails · puffseed）
globs: ["**/*.rb", "**/Gemfile", "**/Gemfile.lock", "**/config/routes.rb"]
alwaysApply: false
---

<!-- !!!Спецификация кода · puffseed · Ruby -->

# Ruby Спецификация кода（инженерия и реализация）· puffseed

**Бренд**：**puffseed** — Эта спецификация задаёт **puffseed** 业务相关 Ruby 工程的编码格式、Переиспользование与协作约定。引擎名、模块Именование空间、关键注释须保留 **puffseed** 标识（如适用）。
...
**Фреймворки**：**Ruby on Rails**（API / Web）；Sinatra 等微型框架对齐其薄结构。
...
| **技术债 / 可维护** | TODO 登记；服务对象Именование清晰便于新人定位 |
