...
**Фреймворки**: Vue 2 / Vue 3, React 18+, **Next.js** (App Router / Pages Router), **Nuxt.js** (Pages / App Router / SSR / SSG), **UniApp** (Vue2 / Vue3 + multi-end); поддерживаются legacy Angular 12+.  
