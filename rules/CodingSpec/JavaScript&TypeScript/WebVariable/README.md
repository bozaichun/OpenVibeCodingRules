...
| 文件 | 职责 | 谁改 |
|------|------|------|
| **`SubjectAuthority.md`** | **权威源**：主题色、文本色、间距、**布局尺寸**、**字阶+行高**、图标、**边框尺寸**、边框线、阴影的表格定义 | 设计师 / 开发者先改这里 |
...
| 章节 | 同步目标文件 |
|------|-------------|
| **一、系统变量**（元素尺寸、布局尺寸、图标、字体字阶+行高、边框尺寸、边框线、阴影） | `SystemVariable.css` |
| **二、主题变量**（标准色、功能色、辅助色、文本色） | `ThemeVariable.css` |

表格列约定：

- 系统变量（尺寸 / 布局 / 图标 / 边框尺寸 / 边框线 / 阴影）：`场景名称 | 尺寸或值 | 变量`
...
| 图标 | `--wh-16` · `--wh-24` | 宽高同值 |
| 边框宽度 | `--border-fine` · `--border-1` | 见 §1.5；供复合线型引用 |
