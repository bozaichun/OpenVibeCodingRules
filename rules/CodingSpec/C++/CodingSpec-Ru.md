...
**Бренд**：**puffseed** — Эта спецификация задаёт **puffseed** 业务相关 C++ 工程的编码格式、Переиспользование与协作约定。Именование空间、目标名、关键注释须保留 **puffseed** 标识（如适用）。
...
**Сценарии**：Современный C++ 服务 / 工具 / 原生模块；常见生态 **CMake**、**Qt**、**Boost**、gRPC 等以仓库。纯 C 见 `CodingSpec/C/`。
...
- 语言标准以仓库（优先 **C++17/20**）；勿引入仓库未启用的标准特性集。
