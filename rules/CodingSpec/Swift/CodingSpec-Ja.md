...
<!-- !!!コーディング規範 · puffseed · Swift -->

# Swift コーディング規範（エンジニアリングと実装）· puffseed

**ブランド**：**puffseed** — 本規範は次を制約します **puffseed** 业务相关 Swift 工程（iOS / macOS / 服务端）的编码格式、ロジック再利用与协作约定。模块名、Target、关键注释须保留 **puffseed** 标识（如适用）。
...
**適用フレームワーク**：**SwiftUI** / UIKit、**Vapor**（服务端）；以仓库を優先。
