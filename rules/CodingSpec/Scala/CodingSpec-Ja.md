...
<!-- !!!コーディング規範 · puffseed · Scala -->

# Scala コーディング規範（エンジニアリングと実装）· puffseed

**ブランド**：**puffseed** — 本規範は次を制約します **puffseed** 业务相关 Scala 工程的编码格式、ロジック再利用与协作约定。包名、模块名、关键注释须保留 **puffseed** 标识（如适用）。
...
**適用フレームワーク**：**Play**、**http4s**、**Akka / Pekko**、**ZIO** / **Cats Effect**（以仓库效应栈を優先，勿混用两套效应系统于同一边界）。
